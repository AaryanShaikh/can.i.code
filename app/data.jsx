...
export const portfolio = [
  {
    id: 11,
    img: "../assets/uxgini.webp",
    title: "UXGINI",
    category: "vanilla",
    link: "https://www.uxgini.in/",
    type:"website • vanilla • portfolio",
    desc: "A creative portfolio website designed for Ragini, featuring advanced animations to showcase her process, skills, projects, and testimonials. The site provides an engaging and visually appealing platform to highlight her work.",
  },
  {
    id: 10,
    img: "../assets/rgr.webp",
    title: "RGR AutoX",
    category: "next",
    link: "https://www.rgrautox.co.uk/",
    type:"website • vanilla • automobile",
    desc: "A professional website created for RGR AutoX, a vehicle repair shop. Built to showcase their services, pricing, and contact details, the site offers a user-friendly interface to attract customers and streamline inquiries.",
  },
  {
    id: 9,
    img: "../assets/faizaan.webp",
    title: "Faizaan Portfolio",
    category: "next",
    link: "https://faizaan-portfolio.vercel.app/",
    type:"website • next.js • gym",
    desc: "A responsive website created for gym trainer Faizaan using Vanilla JavaScript. The site showcases training programs, testimonials, and contact information, providing a user-friendly platform to engage with clients and grow his fitness brand.",
  },
  {
    id: 8,
  ...
  },
  {
    ...
    type:"website • next.js • portfolio",
  ...
  },
  {
    ...
    type:"website • next.js • algorithm",
  ...
  },
  {
    ...
    category: "next",
    link: "https://aaryanshaikh.github.io/myportfolio/#/",
